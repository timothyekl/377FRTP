...
% FIXME: All " need to be replaced with double backticks
...
\input{Listings/HaskellInfiniteSeq.hs.listing}
...
\input{Listings/HaskellAlgebraicTypes.hs.listing}
...
\input{Listings/HaskellPatternMatching.hs.listing}
...
\input{Listings/HaskellDataDeclaration.hs.listing}
...
\input{Listings/HaskellTypeAnnotation.hs.listing}
...
\input{Listings/HaskellRefactoring1.hs.listing}
...
\input{Listings/HaskellRefactoringDemotion.hs.listing}
...
\input{Listings/HaskellAlternateTree.hs.listing}
...
\input{Listings/HaskellRefactoringModuleStatement.hs.listing}
...
\input{Listings/HaskellRefactoringNewFunctions.hs.listing}
...
\input{Listings/HaskellRefactoringRewrite.hs.listing}
